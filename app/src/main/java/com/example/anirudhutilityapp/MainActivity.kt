package com.example.anirudhutilityapp
...
import com.example.anirudhutilityapp.ui.theme.AnirudhUtilityAppTheme
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContent {
            AnirudhUtilityAppTheme {
                AnirudhUtilityApp()
            }
        }
    }
...
@Composable
fun AnirudhUtilityAppPreview() {
    AnirudhUtilityAppTheme {
        AnirudhUtilityApp()
    }
}
@Composable
fun AnirudhUtilityApp() {
